...
const RegisterStore = () => {
  ...
  return (
    <div style={styles.container}>
      <h2>Register as Medical Store</h2>
      <form style={styles.form} onSubmit={handleSubmit}>
        <input name="storeName" placeholder="Store Name" style={styles.input} onChange={handleChange} />
        ...
        <input name="licenseNumber" placeholder="Store License Number" style={styles.input} onChange={handleChange} />
